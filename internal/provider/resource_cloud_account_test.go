...
func TestAccControlPlaneCloudAccount_basic(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccControlPlaneCloudAccountCreateRequiredOnly(),
			...
			{
				Config: testAccControlPlaneCloudAccountUpdateWithOptionals(description),
				Check: resource.ComposeAggregateTestCheckFunc(
					// AWS Resource Check
					resource.TestCheckResourceAttr(aws.resourceName, "name", aws.name),
			...
			{
				Config: testAccControlPlaneCloudAccountUpdateAddTag(updateDescription),
				Check: resource.ComposeAggregateTestCheckFunc(
					// AWS Resource Check
					resource.TestCheckResourceAttr(aws.resourceName, "name", aws.name),
			...
			{
				Config: testAccControlPlaneCloudAccountUpdateWithOptionals(updateDescription),
				Check: resource.ComposeAggregateTestCheckFunc(
					// AWS Resource Check
					resource.TestCheckResourceAttr(aws.resourceName, "name", aws.name),
					resource.TestCheckResourceAttr(aws.resourceName, "description", updateDescription),
			...
			// Update Replace
			{
				Config: testAccControlPlaneCloudAccountUpdateReplace(updateDescription),
				Check: resource.ComposeAggregateTestCheckFunc(
					// AWS Resource Check
					resource.TestCheckResourceAttr(aws.resourceName, "name", aws.name),
					resource.TestCheckResourceAttr(aws.resourceName, "description", updateDescription),
...
func testAccControlPlaneCloudAccountCreateRequiredOnly() string {
	return fmt.Sprintf(`
...
func testAccControlPlaneCloudAccountUpdateWithOptionals(description string) string {
	return fmt.Sprintf(`
resource "cpln_cloud_account" "aws" {
  name        = "%s"
  description = "%s"
...
func testAccControlPlaneCloudAccountUpdateAddTag(description string) string {
	return fmt.Sprintf(`
resource "cpln_cloud_account" "aws" {
  name        = "%s"
  description = "%s"
...
func testAccControlPlaneCloudAccountUpdateReplace(description string) string {
	return fmt.Sprintf(`
resource "cpln_cloud_account" "aws" {
  name        = "%s"
  description = "%s"
