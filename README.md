...
- v1.1.2 - Add `NATS Account` secret. Add NGS cloud account. Add NGS cloud access policy. Sync'ed GVC schema (env will be returned). Added GCP service account name and roles output to cloud account. Add elastic logging to org external logging.
